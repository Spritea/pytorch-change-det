...
from ptsemseg.loader.my_loader_parallel import myLoader_parallel
from ptsemseg.loader.my_loader_6band import myLoader_6band
...
def get_loader(name):
    ...
    return {
        ...
        "my":myLoader,
        "my_parallel":myLoader_parallel,
        "my_6band":myLoader_6band,
    }[name]
