...
def test(args,cfg):
    ...
    with torch.no_grad():
        for i_val, (img_path,image_src,image_dst) in tqdm(enumerate(testloader)):
            img_name=img_path[0]
            ...
            out_path="test_out/changenet_change_det/"+Path(img_name).stem+".png"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="pretrain/changenet_change_det/changenet50_my_parallel_best_model.pkl",
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="configs/changenet_change_det.yml",
