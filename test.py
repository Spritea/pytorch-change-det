...
def test(args,cfg):
    ...
    for j in tqdm(range(len(IMG_Str))):
        ...
        out_path="test_out/CAN_my/bs_20_epoch_100_val_interval_1000/"+Path(img_path).name
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="pretrain/CAN_my/bs_20_epoch_100_val_interval_1000/mv3_res50_my_best_model.pkl",
    ...
    parser.add_argument(
        ...
        default="dataset/SCPA_WC/val", help="Path of the input image"
    )
    parser.add_argument(
        "--out_path",
        nargs="?",
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="configs/mv3_1_true_2_res50_bs12.yml",
